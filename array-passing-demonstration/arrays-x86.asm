...
student_message db "Those two numbers are stored in heap space.  Where do you think they came from?", 10, 0
...
;=========== Just for fun: show two numbers in the heap located immediately before the start of the array =================================================================

mov        rax, 2
;movsd      xmm0,[r13-1*8]                                   ;Copy the number immediately preceding the start of the array to a register for display.
...
mov        rax, 0
mov        rdi, student_message                             ;"Those two numbers are stored in heap space.  Where do you think they came from?"
call       printf
